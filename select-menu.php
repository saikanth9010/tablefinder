...
if (isset($_POST['reservation'])) {
  ...
  $reservation_people = $_POST['number_of_people'];
  // $reservation_randomnum = $_POST['randomnum'];
  $email = $_POST['email'];
  // $table = $_POST["table"];
  // $chair = $_POST["chair"];
        ...
        <div class="col-md-8 dish-menu">
          ...
          <div class="col-md-4">
            ...
            <div class="d-flex ftco-animate">
              <div class="col-md-12 flex-column">
                <div class="row d-block flex-row">
                  ...
                  <div class="col mb-2 d-flex py-4 border" style="background: white;">
                    <div class="align-self-center">
                      <p class="mb-0"><span>Number of People:</span> <a href=""><?php echo $reservation_people; ?></a></p>
                    </div>
                  </div>
                  <!-- <div class="col mb-2 d-flex py-4 border" style="background: white;">
                    <div class="align-self-center">
                      <p class="mb-0"><span>Code:</span> <a href=""><?php echo $reservation_randomnum; ?></a></p>
                    </div>
                  </div> -->
            ...
            <div class="col-lg-12" style="text-align: center;">
                ...
                <input type="hidden" name="reservation_people" value="<?php echo $reservation_people; ?>">
                <?php
                //  include 'dbCon.php';
                //  $con = connect();
                $randomNum=substr(str_shuffle("0123456789"), 0, 5);
                $sql1 = "SELECT unique_code FROM booking_details;";
                $sql2 = $con->query($sql1);
                foreach($sql2 as $r){
                  if($randomNum == $r){
                  }
                ...
                <input type="hidden" name="randomnum" value="<?php echo $randomNum1; ?>">
                <input type="hidden" name="email" value="<?php echo $email; ?>">
                
                <input type="submit" value="Confirm" name="confirm" class="btn btn-primary py-3 px-5" ></p>
