        ...
        <div class="row">
          <div class="col-md-12 dish-menu">
            ...
            <div class="nav nav-pills justify-content-center ftco-animate" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link py-3 px-4 active" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="true"><span class="flaticon-cutlery"></span> As Restaurant</a>              
            </div>
