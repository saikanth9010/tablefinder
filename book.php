	              ...
	              <h2 class="h4 mb-4">Contact Information</h2>
		            <div class="col mb-3 d-flex py-4 border" style="background: white;">
		                <div class="align-self-center">
							...
							<p class="mb-0"><span>No Of Persons:</span> <a href=""><?php echo $reservation_people; ?></a></p>
...
<!--             <div class="col-md-12">
          	...
          	<form action="manage-insert.php" method="POST">
                ...
                <div class="form-group">
                  <input type="hidden" name="transaction_id" class="form-control" placeholder="Transaction Id" value="xyz">
                </div>
	                <input type="hidden" name="res_id" value="<?php echo $res_id; ?>">
	                <input type="hidden" name="total_price" value="xyz">
					...
					<input type="hidden" name="reservation_randomnum" value="<?php echo $reservation_randomnum; ?>">
