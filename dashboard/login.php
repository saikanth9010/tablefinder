...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<link rel="shortcut icon" href="images/tablefindericon.png">
					...
					<div class="panel-body">
						<form action="" method="POST">
							...
							<div class="mb-xs text-center">
								...
								<p class="btn btn mb-md ml-xs mr-xs">Forgot Password <a href="forgotpassword.php">Click Here</a> </p>
								<p class="btn btn mb-md ml-xs mr-xs">New Here <a href="../registerrestaurant.php">Register Here</a> </p>
							</div>
