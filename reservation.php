              ...
              <form action="restaurant-list.php" method="POST" class="d-block d-lg-flex">
                <div class="fields d-block d-lg-flex">
                  ...
                  <div class="select-wrap one-half">
                    ...
                    <select data-plugin-selectTwo name="area" id="" class="form-control populate" required=""  style="cursor: pointer" ;>
                      ...
                      <?php 
                        ...
                        foreach ($result as $r) {
                      ?>
                      <option value="<?php echo $r['province_name']; ?>"><?php echo $r['province_name']; ?></option>
                      <?php } ?>
                    </select>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="number_of_people" class="form-control" placeholder="Number of People" required="" value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-12 mt-3">
                  <div class="form-group">
                    ...
                    <?php $resid = $_GET['res_id']; 
                                              $sql1 = "SELECT * FROM `restaurant_info` WHERE id = '$resid'";
                                              $sqlresult = $con->query($sql1);
